...
#--------------------
    try:
        ...
        # Channel Dump အတွက် အောက်က line ကို မှန်ကန်စွာ ထည့်သွင်းထားပါတယ်
        DUMP_CHANNEL_ID = int(getenv("DUMP_CHANNEL_ID")) 
        
    except Exception as e:
        LOGGER.warning(f"BOT : Essential Configs are missing or invalid: {e}")
        # အကယ်၍ DUMP_CHANNEL_ID မရှိဘဲ bot ကို run ချင်ရင် exit(1) ကို ခဏ ပိတ်ထားလို့ရပါတယ်
        # exit(1) 
